    ...
    <>
      <header
        className={cn(
          ...
          isScrolled
            ? 'bg-white/97 backdrop-blur-lg shadow-[0_1px_0_0_#E5E7EB,0_4px_24px_-4px_rgba(0,0,0,0.06)] py-2.5 sm:py-3'
            : 'bg-white border-b border-border-main py-2.5 sm:py-3.5 lg:py-4'
        )}
      >
        <div className="container">
          <div className="flex items-center justify-between gap-3 lg:gap-4">
            <a
              ...
              className="group shrink-0 min-w-0 flex-1 lg:flex-none py-0.5"
            ...
            <button
              type="button"
              className="lg:hidden p-2.5 rounded-xl text-text-main hover:bg-bg-alt active:scale-95 transition-all touch-manipulation shrink-0"
